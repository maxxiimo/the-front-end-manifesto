...
**Step 1** - Delete the default *public/index.html* file, and the *assets/images/rails.png* image, as well as the *app/views/layouts/application.html.erb* file you are replacing with application.html.haml.
