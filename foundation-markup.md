...
2. Provide example code and the files you will need to set up a front end code foundation, which you can freely use or modify for your own projects if you wish to.
