...
1.  If you have not done so already per the [Foundation Markup][] chapter, add 'compass-rails' to your gemfile. For more explicit directions from the gem source take a look at: [compass-rails][]
